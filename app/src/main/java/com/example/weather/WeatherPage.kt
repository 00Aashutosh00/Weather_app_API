...
fun Weatherpage(viewModel: WeatherViewModel) {
    ...
    val Keyboradcontrollere = LocalSoftwareKeyboardController.current
    ...
    Column(
        ...
        Row(
            ...
            IconButton(onClick = {
                ...
                if (Keyboradcontrollere != null) {
                    Keyboradcontrollere.hide()
                }
            }) {

                Icon(
                    imageVector = Icons.Default.Search,
                    contentDescription = "seach for any location"
                )
            }
        }
        ...
        Card {
            Column (modifier = Modifier.fillMaxWidth()) {
                ...
                Row(modifier = Modifier.fillMaxWidth(),
                    ...
                    weatherKeyval(key = "Precip", value = data.current.precip_mm+ " mm" )
                }
                Row(modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.SpaceAround){
